...
class Config(object):
    def __init__(self):
        ...
        # absolute & code & output dir
        self.head_dir = '/media/dkjin/3535ee90-f88e-4f09-b6aa-cfbf15169dde/'
        ...
        if self.dataset == 'SEL':
            self.dataset_dir = self.head_dir + 'Semantic_Line_Detection/Dataset/'
            self.img_dir = self.dataset_dir + 'ICCV2017_JTLEE_images/'
        elif self.dataset == 'SEL_Hard':
            self.dataset_dir = self.head_dir + 'Github/Semantic-Line-DRM/Semantic_line_detection/preprocessed/output/SEL_Hard/'
